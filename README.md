...
Landing Page: ![Landing Page](placeholder_link_here)

Prediction Dashboard: ![Dashboard](placeholder_link_here)

Explainable AI Matrix: ![AI Reasoning](placeholder_link_here)

Forecast Chart: ![Chart](placeholder_link_here)
